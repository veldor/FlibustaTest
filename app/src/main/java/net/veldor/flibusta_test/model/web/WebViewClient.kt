...
class WebViewClient internal constructor(val context: Context) : WebViewClient() {
    ...
    override fun shouldInterceptRequest(
        ...
        Log.d("surprise", "WebViewClient.kt 36: intercept $requestString")
...
/*
    ...
    private fun handleRequest(view: WebView, incomingUrl: String): WebResourceResponse? {
        ...
        return try {
            ...
            Log.d("surprise", "WebViewClient.kt 133: mime is $mime")
...
/*            if (isBookFormat(mime)) {
                ...
                val dao = DatabaseInstance.instance.mDatabase.booksDownloadScheduleDao()
                dao.insert(newBook)
