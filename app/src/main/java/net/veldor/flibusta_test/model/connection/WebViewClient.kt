...
class WebViewClient internal constructor(
    ...
    override fun shouldInterceptRequest(
        ...
        val requestString = request.url.path
        ...
        return handleRequest(view, request.url.toString())
    }
    ...
    private fun injectMyCss(originalCss: String?): String? {
        ...
        try {
            ...
            if (PreferencesHandler.nightMode == PreferencesHandler.NIGHT_THEME_NIGHT || (PreferencesHandler.nightMode != PreferencesHandler.NIGHT_THEME_DAY &&
    ...
    private fun handleRequest(view: WebView, incomingUrl: String): WebResourceResponse? {
        ...
        return try {
            mViewMode = PreferencesHandler.browserViewMode
            ...
            if (mime.startsWith(HTML_TYPE)) {
                if (!incomingUrl.startsWith(UrlHelper.getBaseUrl() + "/makebooklist?")) {
                    PreferencesHandler.lastWebViewLink = incomingUrl
