 ...
 * </p>
 */
public class SwipeDownLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private static final String LOG_TAG = SwipeDownLayout.class.getSimpleName();
    ...
    private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                Log.d("surprise", "onAnimationEnd: REFRESH ACTION START!");
     ...
     * @param context
     */
    public SwipeDownLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeDownLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void startProgressAlphaMaxAnimation() {
        Log.d("surprise", "startProgressAlphaMaxAnimation 563:  here max animation!!");
    ...
    /**
     * Set a callback to override {@link SwipeDownLayout#canChildScrollUp()} method. Non-null
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.d("surprise", "onInterceptTouchEvent 774:  here i am");
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.d("surprise", "onInterceptTouchEvent 781:  " + pointerIndex);
                if (pointerIndex < 0) {
                    return false;
                }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.d("surprise", "onInterceptTouchEvent 799:  dragging " + y);
                startDragging(y);
                break;
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        if (remainingDistanceToScroll < 0 && !canChildScrollUp()) {
            ...
            Log.d("surprise", "onNestedScroll 909:  move spinner on " + mTotalUnconsumed);
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        Log.d("surprise", "onNestedScrollAccepted 970:  NESTED SCROLL GO");
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        ...
        if (dy > 0 && mTotalUnconsumed > 0) {
            ...
            Log.d("surprise", "onNestedPreScroll 994:  move spinner here on " + mTotalUnconsumed);
            moveSpinner(mTotalUnconsumed);
        }
    ...
    public void onStopNestedScroll(View target) {
        Log.d("surprise", "onStopNestedScroll 1020:  ============= STOP NESTED SCROLL =======");
    ...
    private void moveSpinner(float overscrollTop) {
        Log.d("surprise", "moveSpinner 1153:  move spinner!");
    ...
    private void finishSpinner(float overscrollTop) {
        Log.d("surprise", "finishSpinner: i finish spinner!");
        if (overscrollTop > mTotalDragDistance) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.d("surprise", "onTouchEvent: touch event! " + ev.getActionMasked());
        final int action = ev.getActionMasked();
        int pointerIndex = -1;
        ...
        Log.d("surprise", "onTouchEvent 1253:  i here!");
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
                Log.d("surprise", "onTouchEvent: event action up");
                pointerIndex = ev.findPointerIndex(mActivePointerId);
                if (pointerIndex < 0) {
                ...
                if (mIsBeingDragged) {
                    Log.d("surprise", "onTouchEvent: i here!");
                    final float y = ev.getY(pointerIndex);
                    final float overscrollTop = (y - mInitialMotionY) * DRAG_RATE;
                    mIsBeingDragged = false;
    ...
    private void startDragging(float y) {
        ...
        if (yDiff > mTouchSlop && !mIsBeingDragged) {
            Log.d("surprise", "startDragging 1321:  start dragging!");
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull SwipeDownLayout parent, @Nullable View child);
    }
}
